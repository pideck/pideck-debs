...
Uploaders:  Alessio Treglia <alessio@debian.org>, Mitchell Smith <mjs@mjsprojects.net>, Daniel James <daniel@64studio.com>
Homepage: http://www.xwax.co.uk/
Standards-Version: 3.9.8
Vcs-Browser: https://anonscm.debian.org/cgit/pkg-multimedia/xwax.git
Vcs-Git: https://alioth.debian.org/anonscm/git/pkg-multimedia/xwax.git
Build-Depends: debhelper (>= 9), libasound2-dev [linux-any], libjack-dev, libsdl-ttf2.0-dev
Package-List:
